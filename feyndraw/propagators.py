...
#    arrw: if True, draw an arrow on the propagator
#    bp: see find_point()
...
def parametric_propagator(ax,p1,p2,ts_fs,h,w,lw=1,color='k',zorder=z_def_prop,hp=0.1):
